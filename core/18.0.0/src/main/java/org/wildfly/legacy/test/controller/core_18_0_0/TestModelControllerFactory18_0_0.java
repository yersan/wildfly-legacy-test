 ...
 * @author Tomaz Cerar
 */
public class TestModelControllerFactory18_0_0 implements TestModelControllerFactory {
    ...
    public ModelTestModelControllerService create(ProcessType processType, RunningModeControl runningModeControl,
        ...
        return new TestModelControllerService18_0_0(processType, runningModeControl, persister, validateOpsFilter, type,
                modelInitializer, new TestModelControllerService18_0_0.DelegatingResourceDefinition(type), processState,
    ...
    public InjectedValue<ContentRepository> getContentRepositoryInjector(ModelTestModelControllerService service) {
        return ((TestModelControllerService18_0_0)service).getContentRepositoryInjector();
    }
}

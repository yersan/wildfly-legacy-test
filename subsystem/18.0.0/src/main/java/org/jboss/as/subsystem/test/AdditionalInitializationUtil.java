...
import org.wildfly.legacy.test.controller.subsystem_18_0_0.TestModelControllerService18_0_0;
...
public class AdditionalInitializationUtil {
    ...
    public static void doExtraInitialization(AdditionalInitialization additionalInit, ControllerInitializer controllerInitializer, ExtensionRegistry extensionRegistry, ManagementModel managementModel, TestModelControllerService18_0_0 controller) {
        controllerInitializer.setTestModelControllerAccessor(new TestControllerAccessor18_0_0(controller));
    ...
    private static class TestControllerAccessor18_0_0 implements TestControllerAccessor {
        private final TestModelControllerService18_0_0 delegate;

        public TestControllerAccessor18_0_0(TestModelControllerService18_0_0 delegate) {
